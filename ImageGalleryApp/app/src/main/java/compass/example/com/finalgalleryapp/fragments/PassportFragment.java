...
public class PassportFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.passport_fragment, container, false);

        passportRecyclerView = (RecyclerView) view.findViewById(R.id.passport_recyclerview);
        passportRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        adapter = new GalleryAdapter(getActivity(), mGalleryItems);
        passportRecyclerView.setAdapter(adapter);
